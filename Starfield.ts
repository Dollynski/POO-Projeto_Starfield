...
const reatorA: Reator = new Reator (
  100,
  new Categoria("A"),
  100
);

const reatorB: Reator = new Reator (
  50,
  new Categoria("B"),
  50
);

const reatorC: Reator = new Reator (
  25,
  new Categoria("C"),
  25
);

const motorA: Motor = new Motor (
  100,
  100,
  100,
  new Categoria("A"),
...
const cargaA: Carga = new Carga (
  "A",
  100,
  100
);

const cargaB: Carga = new Carga (
  "B",
  50,
  50
);

const cargaC: Carga = new Carga (
  "C",
  25,
  25
);
